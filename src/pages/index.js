    ...
    <Layout>
      <section>
        <div className="container">
          ...
          <h2 className="is-size-3">I'm currently the <span className="has-text-weight-bold">Director of Design</span> at <a className="is-link" href="https://www.crew2030.org" target="_blank">Crew2030</a>, leading the design and front end development of the Crew Platform.</h2>
          </div>
      </section>
    </Layout>
  )
